...
send_mail('Hello', 'Very imp msg....','saicharan.p901@gmail.com',['saicharanparvathareddy@gmail.com','skajish726@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'saicharan.p901@gmail.com', [cd['to']]) #use[]
            sent=True;
    else:
	    form=EmailSendForm()
